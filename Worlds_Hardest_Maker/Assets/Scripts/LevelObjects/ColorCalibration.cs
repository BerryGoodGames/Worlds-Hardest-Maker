...
public class ColorCalibration : MonoBehaviour
{
    ...
    [SerializeField] [ConditionalField(new[] { nameof(UseSprites), nameof(UseColorPalette), }, new[] { true, false, })]
    protected uint SharingColorIndex;
    
    [SerializeField] [ConditionalField(new[] { nameof(UseSprites), nameof(UseColorPalette), }, new[] { true, false, })]
    protected uint UniqueColorIndex;
    
    [SerializeField] [ConditionalField(new[] { nameof(UseSprites), nameof(UseColorPalette), }, new[] { true, true, })]
    private Color sharingColor;
