...
{
    [HideInInspector] public MKey.KeyColor color;
    ...
    {
        CPlayer pcontroller = player.GetComponent<CPlayer>();
    ...
    {
        if (player.GetComponent<CPlayer>().KeysCollected(color))
        {
            string tagColor = "";
            if (color == MKey.KeyColor.RED) tagColor = "Red";
            else if (color == MKey.KeyColor.GREEN) tagColor = "Green";
            else if (color == MKey.KeyColor.BLUE) tagColor = "Blue";
            else if (color == MKey.KeyColor.YELLOW) tagColor = "Yellow";
