...
/// </summary>
public class CAnchor : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        transform.parent.SetParent(MGame.Instance.AnchorContainer.transform);
    ...
    {
        MAnchorBall.SetAnchorBall(pos, container.transform);
    }
    ...
    private void RPCAddWaypoint()
    {
        ...
        if (pathController.waypoints.Count > 0 && pathController.waypoints[0].WaypointEditor != null)
            MGame.Instance.BallWindows.GetComponentInChildren<CPathEditor>().UpdateUI();
    }
