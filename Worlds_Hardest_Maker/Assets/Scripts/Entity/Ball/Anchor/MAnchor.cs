...
/// </summary>
public class MAnchor : MonoBehaviour
{
    public static MAnchor Instance { get; private set; }

    private GameObject selectedAnchor;

    public CPathEditor pathEditorController;
    ...
    public GameObject SelectedAnchor
    {
        ...
        set
        {
            if (value.TryGetComponent(out CAnchor AC))
            {
    ...
    public GameObject SetAnchor(Vector2 pos)
    {
        if (GetAnchor(pos) == null)
        {
            ...
            {
                GameObject anchor = Instantiate(MGame.Instance.Anchor, pos, Quaternion.identity, MGame.Instance.AnchorContainer.transform);
                return anchor;
            }
        }
    ...
    public static void SelectAnchor(Vector2 pos)
    {
        ...
        if (anchor != null)
        {
            ...
            if(MGame.Instance.CurrentEditMode != MGame.EditMode.BALL)
                MGame.Instance.CurrentEditMode = MGame.EditMode.ANCHOR;
